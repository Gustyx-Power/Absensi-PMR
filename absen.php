                        ...
                        <div class="card-body">
                            <form action="" method="GET" id="eventSelectForm">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-lg" name="event" id="event" onchange="this.form.submit()">
                                ...
                                <div class="row mb-4">
                                    <div class="col-6">
                                        ...
                                        <p class="mb-0 fw-semibold">
                                            ...
                                            <?= date('H:i', strtotime($selectedEvent['jam_mulai'])) ?> - <?= date('H:i', strtotime($selectedEvent['jam_selesai'])) ?>
                                        </p>
                                    </div>
                                    <div class="col-6">
                                ...
                                <?php if ($hasAttended): ?>
                                    ...
                                    <div class="text-center py-4">
                                        ...
                                        <p class="text-muted mb-0">
                                            ...
                                            <br>
                                            <small>Status: <strong><?= $existingAttendance['status'] ?></strong> | Waktu: <?= date('H:i:s', strtotime($existingAttendance['waktu_absen'])) ?></small>
                                        </p>
                                    </div>
                                <?php else: ?>
                                    <!-- Attendance Form -->
                                    <form action="?event=<?= $selectedEvent['id'] ?>" method="POST">
                                        ...
                                        <div class="text-center mb-4">
                                            ...
                                            <div class="btn-group btn-group-lg" role="group">
                                                <input type="radio" class="btn-check" name="status" id="status_hadir" value="Hadir" checked>
                                        ...
                                        <p class="text-center text-muted mt-3 small">
                                            <i class="bi bi-person me-1"></i>Login sebagai: <strong><?= htmlspecialchars($_SESSION['nama']) ?></strong>
